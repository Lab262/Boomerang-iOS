...
class SearchFriendsViewController: UIViewController {
    ...
    @IBOutlet weak var searchResultEmptyStateLabel: UILabel!
...
extension SearchFriendsViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if self.presenter.profiles.count > 0 {
            self.searchResultEmptyStateLabel.isHidden = true
        } else {
            self.searchResultEmptyStateLabel.isHidden = false
        }
