...
//  Boomerang
//
//  Created by Luís Resende on 28/04/17.
...
class GradientView: UIView {
    ...
    @IBInspectable var middleColor:   UIColor = .blue { didSet { updateColors() }}
    @IBInspectable var endColor:     UIColor = .white { didSet { updateColors() }}
    @IBInspectable var startLocation: Double =   0.05 { didSet { updateLocations() }}
    @IBInspectable var middleLocation: Double =   0.45 { didSet { updateLocations() }}
