...
class OnboardAuthenticationCollectionViewCell: UICollectionViewCell {
    ...
    func setupCell() {
        self.imageView.image = onboardData[OnboardLoginCellKeys.keyImageView] as? UIImage
        self.descriptionLabel.text = onboardData[OnboardLoginCellKeys.keyDescriptionLabel] as? String
    }
}
